...
public:
	...
	//accesseur
	int getIDlinked();
		//variable float temporaire pour avoir des calculs plus précis
	float getx0();
	float getx1();
	float gety0();
	float gety1();
		//variable int pour l'affichage
	int getX0();
	int getX1();
	int getY0();
	int getY1();
	...
	void setx0(int const& val);
	void setx1(int const& val);
	void sety0(int const& val);
	void sety1(int const& val);
