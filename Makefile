...
bin/exec_gen : obj/Generation.o obj/Room.o obj/Corridor.o
	g++ obj/Generation.o obj/Room.o obj/Corridor.o -o bin/exec_gen
...
obj/Generation.o : src/Generation.cpp src/Room.h src/Corridor.h
